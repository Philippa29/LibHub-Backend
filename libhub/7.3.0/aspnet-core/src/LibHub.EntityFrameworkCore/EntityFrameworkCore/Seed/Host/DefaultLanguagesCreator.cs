...
namespace LibHub.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly LibHubDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = LibHubConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LibHubDbContext context)
        {
            _context = context;
        }
