...
namespace LibHub.Migrations
{
    ...
    [Migration("20240313093510_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibHub.Domain.Booking.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SpaceIDId");

                    b.ToTable("Bookings");
                });

            modelBuilder.Entity("LibHub.Domain.Booking.Space", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibHub.Domain.Users.Librarian", b =>
                {
                    b.HasBaseType("LibHub.Domain.Users.Person");
            ...
            modelBuilder.Entity("LibHub.Domain.Users.Student", b =>
                {
                    b.HasBaseType("LibHub.Domain.Users.Person");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LibHub.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LibHub.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LibHub.Domain.Booking.Booking", b =>
                {
                    b.HasOne("LibHub.Domain.Users.Person", "BookedBy")
                        .WithMany()
                        .HasForeignKey("BookedById");

                    b.HasOne("LibHub.Domain.Booking.Space", "SpaceID")
                        .WithMany()
                        .HasForeignKey("SpaceIDId");

                    b.Navigation("BookedBy");

                    b.Navigation("SpaceID");
                });
            ...
            modelBuilder.Entity("LibHub.Domain.Category.Category", b =>
                {
                    b.HasOne("LibHub.Domain.Category.Category", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("LibHub.Domain.Users.Person", b =>
                {
                    b.HasOne("LibHub.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
