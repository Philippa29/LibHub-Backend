...
{
    public abstract class LibHubWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibHubWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibHubWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibHubDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibHubDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibHubDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibHubDbContext, Task<T>> func)
        {
            T result;
